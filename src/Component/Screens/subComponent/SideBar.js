...
const SideBarScreen = () => {
    ...
    return (
        ...
        //             <a onClick={() => navigation('/dashboard')} className="nav-link">
        //             <i className="icon-grid menu-icon"></i>
        //             <span className="menu-title">Dashboard</span>
        //             </a>
        //         </li>
        //         <li className="nav-item">
        //             <a onClick={() => navigation('/places')} className="nav-link">
        //             <i className="icon-layout menu-icon"></i>
        //             <span className="menu-title">Mes Monuments</span>
        //             <i className="menu-title"></i>
        //             </a>
        //         </li>
        //     </ul>
        // </nav>
        ...
        <ul className="nav">
          <li className="nav-item">
            <a className="nav-link" href="#" onClick={() => navigation('/dashboard')}>
              <i className="icon-grid menu-icon"></i>
              <span className="menu-title">Dashboard</span>
            </a>
          </li>
          ...
          <li className="nav-item">
            ...
            <div className="collapse" id="auth">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <a className="nav-link" href="#" onClick={() => navigation('/')}> Login </a></li>
          ...
          <li className="nav-item">
            ...
            <div className="collapse" id="error">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <a className="nav-link" href="#" onClick={() => navigation('/404')}> 404 </a></li>
                <li className="nav-item"> <a className="nav-link" href="#" onClick={() => navigation('/500')}> 500 </a></li>
              </ul>
            </div>
          </li>
          <li className="nav-item">
