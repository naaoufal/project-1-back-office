                        ...
                        <div className="col-lg-7 mx-auto text-white">
                            ...
                            <div className="row mt-5">
                                <div className="col-12 text-center mt-xl-2">
                                    <a className="text-white font-weight-medium" href="#" onClick={() => navigation('/dashboard')}>Back to home</a>
                                </div>
                            </div>
                            <div className="row mt-5">
                                <div className="col-12 mt-xl-2">
                                    <p className="text-white font-weight-medium text-center">Copyright &copy; 2022  All rights reserved.</p>
                                </div>
                            </div>
                        </div>
                    </div>
